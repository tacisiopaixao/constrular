...
import com.constrular.servicos.dto.ClienteDTO;
...
public class ClienteResource {
	...
	public Cliente saveContato(@Valid @RequestBody ClienteDTO clienteDTO) {
		return clienteService.save(clienteDTO.build());
